...
/**
 * Provides the local service interface for IoTComponent. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see IoTComponentLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface IoTComponentLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.iot_catalogue.service.impl.IoTComponentLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the io t component local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link IoTComponentLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	@Indexable(type = IndexableType.DELETE)
	public IoTComponent deleteIoTComponent(
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public IoTComponent getIoTComponentByOriginalId(String originalId)
		throws NoSuchIoTComponentException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public IoTComponent getIoTComponentByOriginalId(
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<IoTComponent> getIoTComponentsBySubscriptionId(
		long subscriptionId);
