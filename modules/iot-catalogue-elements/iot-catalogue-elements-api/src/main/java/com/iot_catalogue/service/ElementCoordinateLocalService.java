...
/**
 * Provides the local service interface for ElementCoordinate. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ElementCoordinateLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ElementCoordinateLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.iot_catalogue.service.impl.ElementCoordinateLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the element coordinate local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ElementCoordinateLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public List<ElementCoordinate> deleteElementCoordinates(
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<ElementCoordinate> getElementCoordinatesBySubscriptionId(
		long subscriptionId);
